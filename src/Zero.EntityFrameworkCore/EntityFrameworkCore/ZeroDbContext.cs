...
namespace Zero.EntityFrameworkCore
{
     ...
     * used modules (as explained above). See ZeroMigrationsDbContext for migrations.
     */
    ...
    public class ZeroDbContext : AbpDbContext<ZeroDbContext>
    {
         ...
         * Also map them inside ZeroDbContextModelCreatingExtensions.ConfigureZero
         */
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<AppUser>(b =>
            {
                 ...
                 * Also see the ZeroEfCoreEntityExtensionMappings class.
                 */
            });
