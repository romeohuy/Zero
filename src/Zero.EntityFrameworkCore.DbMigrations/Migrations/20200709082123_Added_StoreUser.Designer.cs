...
{
    [DbContext(typeof(ZeroMigrationsDbContext))]
    [Migration("20200709082123_Added_StoreUser")]
    partial class Added_StoreUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zero.StoreUsers.StoreUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppStoreUsers");
                });

            modelBuilder.Entity("Zero.Stores.Store", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Zero.StoreUsers.StoreUser", b =>
                {
                    b.HasOne("Zero.Stores.Store", "Store")
                        .WithMany()
